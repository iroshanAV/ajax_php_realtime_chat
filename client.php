<html>
  <head>
	...
	<style link rel="stylesheet" href="form_css.css"></style>
  </head>
  ...
  <body>
	...
	<form id="chat_form" onsubmit="return addComment();">
	  ...
	  <input type="text" id="user_name" name="user_name" value="" /></textarea>
...
<script type="text/javascript">
  ...
  function addComment() {
			...
			$.ajax({
				url : "http://localhost/ajax_projects/chats_ajax/server.php" ,
				type : "get" , 
				data : requestData , 
				dataType : "json" , 
